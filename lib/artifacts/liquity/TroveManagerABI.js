module.exports = [
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: "address", name: "_gasPoolAddress", type: "address" }],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "uint256", name: "_L_LUSDDebt", type: "uint256" },
    ],
    name: "LTermsUpdated",
    type: "event",
  },
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: "uint256", name: "_lastFeeOpTime", type: "uint256" }],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "uint256", name: "_actualLUSDAmount", type: "uint256" },
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: "uint256", name: "_newTotalStakes", type: "uint256" }],
  ...
  },
  {
    ...
    outputs: [
      { internalType: "uint256", name: "debt", type: "uint256" },
      { internalType: "uint256", name: "coll", type: "uint256" },
      { internalType: "uint256", name: "pendingLUSDDebtReward", type: "uint256" },
